...
The MyExtension Specification defines the **MyExtension Object**, which appears
within an OpenAPI document under the `features` field introduced in OpenAPI 3.3:

```yaml
features:
  myextension:
    # MyExtension Object fields here
```
...
A **MyExtension Object** is ...

#### Fixed Fields

| Field Name | Type | Description |
| ---- | ---- | ---- |
| `example` | [Schema Object](#schema-object) | TODO |
...
This document is the MyExtension Specification version 1.0.0.
...
Implementations that validate MyExtension Objects MUST use the schema published at
`https://spec.openapis.org/myextension/1.0/schema/WORK-IN-PROGRESS`.

When validating a MyExtension Object within an OpenAPI document, the Schema Object
schema in effect is determined by the OAS dialect declared in that document.
Standalone validation of MyExtension Objects uses the standard JSON Schema
